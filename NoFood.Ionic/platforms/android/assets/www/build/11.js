...
var AdmCategoriasPage = /** @class */ (function () {
    ...
    AdmCategoriasPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-adm-categorias',template:/*ion-inline-start:"E:\git\NoFood\NoFood.Ionic\src\pages\adm-categorias\adm-categorias.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n\n    <ion-title>Categorias</ion-title>\n\n    <ion-buttons right>\n\n      <button ion-button icon-only (click)="addOrEdit({})">\n\n        <ion-icon name="add"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content no-padding>\n\n  <ion-list lines>\n\n    <ion-item text-wrap *ngIf=\'lista.length == 0\'>\n\n      Você não tem nenhuma categoria cadastrada\n\n    </ion-item>\n\n    <ion-item *ngFor="let item of lista" text-wrap (click)="addOrEdit(item)">\n\n      {{ item.titulo }}\n\n    </ion-item>\n\n  </ion-list>\n\n</ion-content>'/*ion-inline-end:"E:\git\NoFood\NoFood.Ionic\src\pages\adm-categorias\adm-categorias.html"*/,
        }),
